  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      <dl className="grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Field label="Category lock">{CARD_CATEGORY_LABELS[card.category]}</Field>
        <Field label="Spend limit">{formatMoney(card.spendLimit, card.currency)}</Field>
      ...
      <div className="mt-4">
        <SpendProgress spent={card.spent} limit={card.spendLimit} currency={card.currency} />
      </div>
